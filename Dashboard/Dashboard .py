...
def fig_bevoelk(val_years):
    raw_data = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/12411-0005.csv',
...
def fig_gebsterb(vals):
    raw_data_sterbene = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/12613-0002.csv', skiprows=5,
        nrows=73, encoding='ISO-8859-1', delimiter=';')
    raw_data_geborene = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/Geboren_12612-0001.csv',
...
def fig_bev_wanderung(vals):
    raw_data = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/wanderungen-deutschland-ausland-monate.csv',
...
def bev_homoehen_fig():
    # Daten einlesen
    data = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/gleichgeschlechtliche-eheschliessungen.csv',
...
def bev_ehen_fig():
    # Daten einlesen
    data = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/12611-0001.csv',
...
def fig_gebmon(vals):
    # Daten einlesen
    data = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/12612-0002.csv',
...
def fig_erwquo():
    # Daten einlesen
    raw_data = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/allgemein/ausgangdaten/erwerbstaetigkeit-eltern.csv',
...
def dashboard():
    ...
    df_treib = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/treibhausgase_abs.csv')
    df_treib_I90 = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/treibhausgase_I90.csv')
    df_NH3 = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/NH3.csv')
    df_NOX = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/NOX.csv')
    df_NMVOC = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/NMVOC.csv')
    df_PM10 = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/PM10.csv')
    df_BIP = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/BIP.csv')
    df_demo = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/demo.csv')
    df_umweltschutz = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Umwelt/data%20preprocessing/umweltschutz_abs.csv')
    ...
    data_road = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/46131-0003_G%C3%BCterverkehr_Stra%C3%9Fe_bearbeitete_daten.csv')
    data_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/46131-0003_Eisenbahn_bearbeitete_daten.csv')
    data_BIP = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/81000-0001_BWS%2C%20BIP_bearbeitete_daten.csv')
    merge_BIP_road = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/merge_BIP_Strasse.csv')
    merge_BIP_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/merge_BIP_Eisenbahn.csv')
    merge_BIP_road_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/Mobilit%C3%A4t/Data%20preprocessing/merge_BIP_Strasse_Eisenbahn.csv')
